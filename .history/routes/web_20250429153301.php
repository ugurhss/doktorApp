...
Route::view('profile', 'profile')
    ...
    ;
    Route::get('/patient/reschedule/{appointment_id}',[UserController::class,'reschedulingForm']);
 ...
 // ********************************************************************************************************
    ...
    Route::group(['middleware' => 'doctor'],function(){
        ...
        Route::get('/doctor/reschedule/{appointmend_id}',[DoctorController::class,'rescheduledit'])
        ->name('doctor.rescheduleform');

        Route::get('/doctor/reschedule/{appointment_id}',[DoctorController::class,'reschedulingForm']);
