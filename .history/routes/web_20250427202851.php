...
Route::view('profile', 'profile')
    ->middleware(['auth'])
    ->name('profile');
    Route::get('/filter-by-speciality/{speciality_id}',[UserConteoller::class,'loadDoctorBySpeciality']);
    Route::get('/my-appointments', [UserConteoller::class, 'loadMyAppointments'])->name('my.appointments');

    Route::get('/articles',[UserConteoller::class,'loadArticles'])
    ->name('articles');
