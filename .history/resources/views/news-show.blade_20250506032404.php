        ...
        <div class="bg-white dark:bg-neutral-900 shadow-xl rounded-lg p-6">
            ...
            <div class="mt-6">
                @if($news->image)
                    ...
                    @if(is_array($images) && count($images) > 0)
                            ...
                            <div class="swiper-wrapper">
                                @foreach($images as $image)
                                    <div class="swiper-slide">
                                        <img class="w-full object-cover rounded-lg" src="{{ $image }}" alt="News Image">
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <script>
                            var swiper = new Swiper('.swiper-container', {
                                spaceBetween: 10, // Resimler arası mesafe
                                autoplay: {
                                    delay: 3000, // Her 3 saniyede bir resim geçişi
                                },
                                loop: true, // Döngüsel olarak dönmesini sağlar
                                navigation: {
                    ...
                    @else
                        <img class="w-full object-cover rounded-lg" src="https://cdnuploads.aa.com.tr/uploads/Contents/2025/04/02/thumbs_b_c_37d45cdf92b25d4d153e882d6cbc9602.jpg?v=230229" alt="Default Image">
                    @endif
                @else
                    <img class="w-full object-cover rounded-lg" src="https://i.tgrthaber.com/images/haberler/25-02/04/galatasarayda-gece-yarisi-transfer-operasyonu-imza-icin-istanbula-geldi-17386415288989.jpg" alt="Default Image">
                @endif
            </div>
