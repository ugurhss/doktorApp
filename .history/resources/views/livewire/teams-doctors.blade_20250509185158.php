...
<div class="max-w-[85rem] px-4 py-16 sm:px-6 lg:px-8 lg:py-20 mx-auto bg-white">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div class="p-6">
                ...
                <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                  ...
                  <div class="flex space-x-2">
                    ...
                    @endif
                    @if($item->instagram)
                    <a href="{{$item->instagram}}" target="_blank" class="inline-flex justify-center items-center size-8 rounded-full bg-gray-50 text-gray-500 hover:bg-pink-50 hover:text-pink-500 transition-colors">
                      <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                  ...
                  <!-- Appointment Button -->
                  @if (auth()->user() != null)
                    <a href="/booking/page/{{$item->id}}" class="py-2 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-500 text-white hover:bg-blue-600 transition-colors shadow-sm">
                      Randevu Al
                      <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
                    </a>
                  @else
                    <a href="/login" class="py-2 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-500 text-white hover:bg-blue-600 transition-colors shadow-sm">
                      Randevu Al
                      <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
                    </a>
                  @endif
        ...
        <!-- View All Card -->
        <a class="group flex flex-col justify-center items-center text-center rounded-xl p-8 md:p-10 border-2 border-dashed border-gray-200 hover:border-blue-400 hover:bg-blue-50/30 transition-all" href="/">
          <div class="size-16 bg-blue-100 rounded-full flex items-center justify-center mb-4">
            <svg class="size-8 text-blue-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <span class="inline-flex items-center gap-x-2 text-blue-500 group-hover:text-blue-600 font-medium">
            Tümünü görüntüle
            <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
          </span>
        </a>
