    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
           ...
           <a href="">
            <div class="flex flex-col gap-y-3 lg:gap-y-5 p-4 md:p-5 bg-white border shadow-sm hover:shadow-md rounded-xl dark:bg-neutral-900 dark:border-neutral-800">
              <div class="inline-flex justify-center items-center">
                ...
                <span class="text-xs font-semibold uppercase text-gray-600 dark:text-neutral-400">Kayıtlı toplam kullanıcı </span>
              </div>
              ...
              <dl class="flex justify-center items-center divide-x divide-gray-200 dark:divide-neutral-800">
                <dt class="pe-3 text-center">
                  ...
                  <span class="block text-sm text-gray-500 dark:text-neutral-500">geçen ay</span>
                </dt>
                <dd class="text-start ps-3">
                  <span class="text-sm font-semibold text-gray-800 dark:text-neutral-200">{{$last_week_users_count}}</span>
                  <span class="block text-sm text-gray-500 dark:text-neutral-500">geçen hafta</span>
                </dd>
              </dl>
            </div>
          </a>
      ...
      <div class="flex flex-col gap-y-3 lg:gap-y-5 p-4 md:p-5 bg-white border shadow-sm hover:shadow-md rounded-xl dark:bg-neutral-900 dark:border-neutral-800">
        <div class="inline-flex justify-center items-center">
          ...
          <span class="text-xs font-semibold uppercase text-gray-600 dark:text-neutral-400">Uzman</span>
        </div>
      ...
      <div class="flex flex-col gap-y-3 lg:gap-y-5 p-4 md:p-5 bg-white border shadow-sm hover:shadow-md rounded-xl dark:bg-neutral-900 dark:border-neutral-800">
        <div class="inline-flex justify-center items-center">
          ...
          <span class="text-xs font-semibold uppercase text-gray-600 dark:text-neutral-400">Kullanıcı</span>
        </div>
      ...
      <div class="flex flex-col gap-y-3 lg:gap-y-5 p-4 md:p-5 bg-white hover:shadow-md border shadow-sm rounded-xl dark:bg-neutral-900 dark:border-neutral-800">
        <div class="inline-flex justify-center items-center">
          ...
          <span class="text-xs font-semibold uppercase text-gray-600 dark:text-neutral-400">Radevu  sayısı </span>
        </div>
        ...
        <dl class="flex justify-center items-center divide-x divide-gray-200 dark:divide-neutral-800">
          <dt class="pe-3 text-center">
            ...
            <span class="block text-sm text-gray-500 dark:text-neutral-500">lgeçen ay</span>
          </dt>
          <dd class="text-start ps-3">
      ...
      <div class="flex flex-col gap-y-3 lg:gap-y-5 p-4 md:p-5 bg-white border shadow-sm hover:shadow-md rounded-xl dark:bg-neutral-900 dark:border-neutral-800">
        <div class="inline-flex justify-center items-center">
          ...
          <span class="text-xs font-semibold uppercase text-gray-600 dark:text-neutral-400">Uzmanlık dal sayısı</span>
        </div>
        ...
        <dl class="flex justify-center items-center divide-x divide-gray-200 dark:divide-neutral-800">
                <dt class="pe-3 text-center">
                  ...
                  <span class="block text-sm text-gray-500 dark:text-neutral-500">Gecen ay</span>
                </dt>
                <dd class="text-start ps-3">
                  <span class="text-sm font-semibold text-gray-800 dark:text-neutral-200">0</span>
                  <span class="block text-sm text-gray-500 dark:text-neutral-500">gecen hafta</span>
                </dd>
              </dl>
      </div>
      </a>
      ...
      @if (auth()->user() && auth()->user()->role == 1)
           ...
           <a href="/doctor/appointments">
              <div class="flex flex-col gap-y-3 lg:gap-y-5 p-4 md:p-5 bg-white border shadow-sm hover:shadow-md rounded-xl dark:bg-neutral-900 dark:border-neutral-800">
                <div class="inline-flex justify-center items-center">
                  <span class="size-2 inline-block bg-blue-500 rounded-full me-2"></span>
                  <span class="text-xs font-semibold uppercase text-gray-600 dark:text-neutral-400">Tüm randevular </span>
                </div>
                ...
                <dl class="flex justify-center items-center divide-x divide-gray-200 dark:divide-neutral-800">
                  <dt class="pe-3 text-center">
                    <span class="text-sm font-semibold text-gray-800 dark:text-neutral-200">{{$last_month_appointments_count}}</span>
                    <span class="block text-sm text-gray-500 dark:text-neutral-500">gecenh ayh</span>
                  </dt>
                  <dd class="text-start ps-3">
                    <span class="text-sm font-semibold text-gray-800 dark:text-neutral-200">{{$last_week_appointments_count}}</span>
                    <span class="block text-sm text-gray-500 dark:text-neutral-500">gecen hafta</span>
      ...
      <div class="flex flex-col gap-y-3 lg:gap-y-5 p-4 md:p-5 bg-white border shadow-sm hover:shadow-md rounded-xl dark:bg-neutral-900 dark:border-neutral-800">
        <div class="inline-flex justify-center items-center">
          <span class="size-2 inline-block bg-yellow-500 rounded-full me-2"></span>
          <span class="text-xs font-semibold uppercase text-gray-600 dark:text-neutral-400">Yaklaşan Randevular</span>
        </div>
        ...
        <dl class="flex justify-center items-center divide-x divide-gray-200 dark:divide-neutral-800">
                <dt class="pe-3 text-center">
                  <span class="text-sm font-semibold text-gray-800 dark:text-neutral-200">0</span>
                  <span class="block text-sm text-gray-500 dark:text-neutral-500">gecen Month</span>
                </dt>
                <dd class="text-start ps-3">
                  <span class="text-sm font-semibold text-gray-800 dark:text-neutral-200">0</span>
                  <span class="block text-sm text-gray-500 dark:text-neutral-500">gecen week</span>
                </dd>
              </dl>
