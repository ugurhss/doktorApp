...
<div class="flex w-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
    <!-- Left Image -->
    <div class="w-full lg:w-1/2 bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1606660265514-358ebbadc80d?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1575&q=80');">
        <!-- Optional: Add dark overlay for better text contrast -->
        <div class="bg-black bg-opacity-40 w-full h-full"></div>
    </div>
            ...
            <div class="mt-4">
                <div class="flex justify-between">
                    ...
                    @if (Route::has('password.request'))
                        <a class="text-xs text-gray-500 dark:text-gray-300 hover:underline" href="{{ route('password.request') }}" wire:navigate>
