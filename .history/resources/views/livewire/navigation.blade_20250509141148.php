...
<header class="flex flex-wrap md:flex-col md:justify-start md:flex-nowrap z-50 w-full bg-gradient-to-r from-lime-500 to-green-400 border-b border-gray-200 shadow-md rounded-b-xl overflow-hidden">
    ...
    <div class="max-w-[85rem] mx-auto w-full px-4 sm:px-6 lg:px-8">
      <div class="flex-1 flex items-center justify-end gap-x-3 pt-2 text-white">
        <a class="inline-flex justify-center items-center gap-x-2 font-medium text-sm hover:text-yellow-200 focus:outline-none" href="#">
    ...
    <nav class="relative max-w-[85rem] w-full mx-auto md:flex md:items-center md:justify-between md:gap-3 py-2 px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center gap-x-1 text-white">
        <a class="flex-none font-bold text-xl text-white focus:outline-none" href="#" aria-label="Brand">Logo</a>
