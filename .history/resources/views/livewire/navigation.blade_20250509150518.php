          ...
          <div class="py-2 md:py-0 flex flex-col md:flex-row md:items-center gap-0.5 md:gap-1">
            <div class="grow">
              <div class="flex flex-col md:flex-row md:justify-end md:items-center gap-0.5 md:gap-1">
                ...
                <!-- Active Menu Item -->
                <div class="relative">
                  <a class="p-2 flex items-center text-sm font-medium text-white hover:bg-white/10 rounded-xl focus:outline-none focus:bg-white/20 transition-all"
                     href="{{ route('news.byMenu', ['menu' => 'hizmetlerimiz']) }}">
                    Hizmetlerimiz
                    <span class="absolute bottom-0 left-0 w-full h-0.5 bg-white"></span>
                  </a>
                </div>

                <a class="p-2 flex items-center text-sm text-white hover:bg-white/10 rounded-xl focus:outline-none focus:bg-white/20 transition-all"
                   href="{{ route('news.byMenu', ['menu' => 'hakkımızda-1']) }}">
                  Hakkımızda
                </a>

                <a class="p-2 flex items-center text-sm text-white hover:bg-white/10 rounded-xl focus:outline-none focus:bg-white/20 transition-all"
                   href="{{ route('news.byMenu', ['menu' => 'Projeler-2']) }}">
                  Projeler
                </a>

                <a class="p-2 flex items-center text-sm text-white hover:bg-white/10 rounded-xl focus:outline-none focus:bg-white/20 transition-all"
                   href="{{ route('news.byMenu', ['menu' => 'kanser-hakkında-3']) }}">
                  Kanser Hakkında
                </a>
                ...
                <a class="p-2 flex items-center text-sm text-white hover:bg-white/10 rounded-xl focus:outline-none focus:bg-white/20 transition-all"
                   href="{{ route('video', ['menu' => 'umut-dolu-videolar-5']) }}">
                  Umut Dolu Videolar
                </a>

                <a class="p-2 flex items-center text-sm text-white hover:bg-white/10 rounded-xl focus:outline-none focus:bg-white/20 transition-all"
                   href="{{ route('video', ['menu' => 'faliyetlerimiz-6']) }}">
                  Faaliyetlerimiz
                </a>

                <a class="p-2 flex items-center text-sm text-white hover:bg-white/10 rounded-xl focus:outline-none focus:bg-white/20 transition-all"
                   href="{{ route('video', ['menu' => 'medya-haberlerimiz-7']) }}">
                  Medya Haberlerimiz
                </a>

                <a class="p-2 flex items-center text-sm text-white hover:bg-white/10 rounded-xl focus:outline-none focus:bg-white/20 transition-all"
                   href="{{ route('video', ['menu' => 'nasıl-destek-olabilirim-8']) }}">
                  Nasıl Destek Olabilirim
                </a>

                <a class="p-2 flex items-center text-sm text-white hover:bg-white/10 rounded-xl focus:outline-none focus:bg-white/20 transition-all"
                   href="{{ route('video', ['menu' => 'İletisim-9']) }}">
                  İletişim
                </a>
