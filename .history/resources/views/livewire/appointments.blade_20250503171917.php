                        ...
                        @else
                          ...
                          <td class="size-px whitespace-nowrap align-top">
                            <div class="flex p-6">
                              ...
                              @if (auth()->user()->role == 0)
                              {{-- user --}}
                                    <a href="/user/reschedule/{{$appointment->id}}" class="bg-blue-500 rounded text-white p-1">
                                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                              ...
                              <button class="bg-red-500 rounded text-white p-1 ml-3" wire:click="cancel({{$appointment->id}})" wire:confirm="İptal etmek isteginine emin misin?">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                  <path stroke-linecap="round" stroke-linejoin="round" d="m9.75 9.75 4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                </svg>
                              </button>
