                        ...
                        @else
                          ...
                          <td class="size-px whitespace-nowrap align-top">
                            <div class="block p-6" href="#">
                              ...
                              @else
                              <span class="py-1 px-1.5 inline-flex items-center gap-x-1 text-xs font-medium bg-red-100 text-yellow-800 rounded-full dark:bg-yellow-500/10 dark:text-yellow-500">
