                ...
                @if (count($doctors) > 0)
                    @foreach ($doctors as $item)
                         <tr >
                          ...
                          <td class="h-px w-auto whitespace-nowrap">
                           <button wire:confirm.prevent="Sil?" wire:click="delete({{$item->id}})" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-red-600 text-white hover:bg-red-700 disabled:opacity-50 disabled:pointer-events-none">
                              Delete
                            </button>
                          </td>
                        </tr>
