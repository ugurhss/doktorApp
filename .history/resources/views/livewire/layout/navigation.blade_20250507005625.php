    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-link :href="route('newsList')" :active="request()->routeIs('admin.dashboard')" wire:navigate>
                    {{ __('Haberler') }}
                    </x-nav-link>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (auth()->user() && auth()->user()->role == 2)
                        ...
                        <x-nav-link :href="route('admin.specialities')" :active="request()->routeIs('doctor.specialities')" wire:navigate>
                            ...
                            <x-nav-link :href="route('admin.newslist')" :active="request()->routeIs('admin.dashboard')" wire:navigate>
                                {{ __('Haber Yönetimi') }}
                                </x-nav-link>
                    ...
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" wire:navigate>
                     ...
                     <x-nav-link :href="route('news.creat')" :active="request()->routeIs('news.creat')" wire:navigate>
                        Haber Oluştur
                    </x-nav-link>
