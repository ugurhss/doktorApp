...
<div class="p-4 md:p-5 break-words overflow-hidden">
    ...
    <h3 class="mt-2 text-lg font-semibold text-gray-800 group-hover:text-blue-600 :text-neutral-300 :group-hover:text-white break-words">
        {{ $news->title }}
    </h3>

    <!-- Content preview -->
    <p class="mt-2 text-sm text-white dark:text-white break-words line-clamp-3">
