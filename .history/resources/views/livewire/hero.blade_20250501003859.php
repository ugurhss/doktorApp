    ...
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
      ...
      <div class="flex justify-center">
        <a class="inline-flex items-center gap-x-2 bg-white border border-gray-200 text-xs text-gray-600 p-2 px-3 rounded-full transition hover:border-gray-300 focus:outline-hidden focus:border-gray-300" href="#">
         Diger Projelerimi Görmek İçin
          <span class="flex items-center gap-x-1">
            <span class="border-s border-gray-200 text-blue-600 ps-2">Tıklayın</span>
      ...
      <div class="mt-5 max-w-3xl text-center mx-auto">
        <p class="text-lg text-gray-600">Bugün kendin için bir şey yap. Derin bir nefes al, minnet duyduğun bir şeyi hatırla, birine "teşekkür ederim" de. Çünkü kaliteli günler, bu küçük detaylarda saklıdır..</p>
      </div>
