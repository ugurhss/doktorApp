            ...
            @foreach($news as $new)
                <div class="col-md-4 mb-4">
                    <div class="card shadow-sm">
                        <!-- Görsel kontrolü -->
                        <img src="{{ $new->image_url ?: 'https://i.tgrthaber.com/images/haberler/25-02/04/galatasarayda-gece-yarisi-transfer-operasyonu-imza-icin-istanbula-geldi-17386415288989.jpg' }}" class="card-img-top" alt="{{ $new->title }}">
                        <div class="card-body">
