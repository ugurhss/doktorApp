@foreach ($doctors as $doctor)
    <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-neutral-900 dark:border-neutral-700">
        ...
        <div class="flex justify-between mt-5">
            ...
            @if (auth()->check())
                <a href="{{ route('admin.create.doctor') }}" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
                    Book Appointment
                </a>
            @else
