<div class="max-w-4xl mx-auto p-6 bg-gray-900 dark:bg-gray-900 rounded-lg shadow-lg">
    ...
    <form wire:submit.prevent="save">
        ...
        <div class="mb-6">
            ...
            <select wire:model="menus" id="menus" class="mt-1 p-3 w-full rounded-md border border-yellow-500 dark:border-yellow-500 bg-yellow-200 dark:bg-yellow-300 text-gray-900 dark:text-gray-800 focus:outline-none focus:ring-2 focus:ring-yellow-500">
