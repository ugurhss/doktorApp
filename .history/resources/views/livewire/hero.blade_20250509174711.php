...
<div class="absolute bottom-0 left-0 right-0 overflow-hidden">
    <div class="wave-animation" style="width: 200%;">
      <svg viewBox="0 0 1440 200" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
        <path d="M0 100L60 85C120 70 240 40 360 40C480 40 600 70 720 85C840 100 960 100 1080 85C1200 70 1320 40 1380 20L1440 0V200H1380C1320 200 1200 200 1080 200C960 200 840 200 720 200C600 200 480 200 360 200C240 200 120 200 60 200H0V100Z" fill="white"/>
      </svg>
    </div>
  </div>
</section>
