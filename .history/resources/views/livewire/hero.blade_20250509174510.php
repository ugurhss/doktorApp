...
<section class="relative bg-gradient-to-r from-emerald-600 to-lime-500 overflow-hidden">
    ...
    <div class="grid md:grid-cols-2 gap-12 items-center">
      ...
      <div class="text-center md:text-left hero-animate">
        ...
        <div class="mt-12 flex flex-wrap justify-center md:justify-start gap-6 hero-animate" style="transition-delay: 0.6s">
            <div class="flex items-center bg-emerald-700 p-4 rounded-lg shadow-lg transform transition-all duration-300 hover:scale-105">
              <div class="p-3 bg-emerald-600/80 rounded-lg mr-3 backdrop-blur-sm">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-emerald-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
              </div>
              <div>
                <p class="text-sm text-white/90">Gönüllü</p>
            ...
            <div class="flex items-center bg-emerald-700 p-4 rounded-lg shadow-lg transform transition-all duration-300 hover:scale-105">
              ...
              <div>
                <p class="text-sm text-white/90">Başarı Hikayesi</p>
  ...
  <div class="absolute bottom-0 left-0 right-0 overflow-hidden">
    <div class="wave-animation" style="width: 200%;">
