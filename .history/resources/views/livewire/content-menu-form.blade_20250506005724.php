<div class="max-w-4xl mx-auto p-6 bg-gray-900 dark:bg-gray-900 rounded-lg shadow-lg">
    ...
    <form wire:submit.prevent="save">
        ...
        <div class="mb-6">
            ...
            <select wire:model="menus" id="menus" class="mt-1 p-3 w-full rounded-md border border-gray-600 dark:border-gray-600 bg-gray-800 dark:bg-gray-800 text-gray-300 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500" multiple>
