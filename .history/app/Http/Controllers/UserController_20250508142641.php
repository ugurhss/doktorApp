...
class UserController extends Controller
{
    ...
    {
       // Veritabanından video linki olan haberleri alalım
       $videos = News::whereNotNull('video_link')->latest()->get();

       // Livewire bileşenine veri göndermek için
       return view('user.mp4', ['videos' => $videos]);
    }
