...
class VideoManager extends Component
{
    ...
    public function create()
    {
        $this->validate([
            ...
            'video_link' => 'required|url',  // Ensure this is a valid URL
        ]);

        News::create([
            'title' => $this->title,
            'details' => $this->details,
            'video_link' => $this->video_link,  // Save the video link
        ]);

        session()->flash('message', 'Video successfully created.');
        $this->resetForm();
        $this->videos = News::whereNotNull('video_link')->get(); // Refresh the video list
    }
    ...
    public function update()
    {
        ...
        $video->update([
            'title' => $this->title,
            'details' => $this->details,
            'video_link' => $this->video_link,  // Update the video link
        ]);
