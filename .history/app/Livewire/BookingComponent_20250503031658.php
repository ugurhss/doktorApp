...
class BookingComponent extends Component
{
    ...
    public function bookAppointment($slot){
        ...
        session()->flash('message','randevu ile Dgn.'.$this->doctor_details->doctorUser->name.' on '.$this->selectedDate.$slot.' oluştu!');
    ...
    public function fetchTimeSlots($date, $doctor)
    {
        ...
        $schedule = DoctorSchedul::where('doctor_id', $doctor->id)
