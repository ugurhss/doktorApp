...
use App\Models\News; // News modelini kullanıyoruz
...
class VideoManager extends Component
{
    ...
    // Livewire component'ını render etmek için
    public function render()
    {
        // Video yönetim sayfasını render ediyoruz
        return view('livewire.video-manager', [
            'videos' => $this->videos, // Video listelerini view'e gönderiyoruz
        ]);
    }
}
